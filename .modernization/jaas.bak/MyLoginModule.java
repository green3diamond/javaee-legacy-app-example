...
public class MyLoginModule implements LoginModule {
	...
	public boolean commit() throws LoginException {
		...
		// TODO (Task 7): Replace this entire JAAS module with Spring Security
		// The SimpleGroup/SimplePrincipal code below is JBoss-specific and will be removed
		// in Task 7 when we migrate to Spring Security
		/*
		// Roles
